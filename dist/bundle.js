...
function forms (formSelector, modalTimerId) {
   ...
   function bindPostData(form) {
       form.addEventListener('submit', (e) => {
           ...
           (0,_sevices_services__WEBPACK_IMPORTED_MODULE_1__.postData)('http://localhost:3000/requests', json)  // функционал по общению с сервером
           // .then(data => data.text())
           .then(data => {
               console.log(data);
...
function slider({container, slide, nextArrow, prevArrow, totalCounter, currentCounter, wrapper, field}) {
    //Slider
      ...
      const slides = document.querySelectorAll(slide),
            slider = document.querySelector(container),               //добавлен на сложном слайдере 
            prev = document.querySelector(prevArrow),
            next = document.querySelector(nextArrow),
            total = document.querySelector(totalCounter),
            current = document.querySelector(currentCounter),
            slidesWrapper = document.querySelector(wrapper), //добавлен на сложном слайдере 
            slidesField = document.querySelector(field),  //добавлен на сложном слайдере 
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2022-04-11');
